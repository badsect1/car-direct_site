"""
다이렉트 자동차보험 다나와(car-direct.kr) - 호스팅어(Hostinger) SFTP 자동 배포 스크립트
...
REMOTE_DIR = config.get('FTP_REMOTE_DIR') or os.environ.get('FTP_REMOTE_DIR') or 'domains/car-direct.kr/public_html'
...
def main():
    print("🚀 === car-direct.kr 호스팅어(Hostinger) SFTP 자동 배포 시작 ===")
    ...
    try:
        ...
        print("👉 라이브 확인 주소:")
        print("   - 메인 사이트: https://car-direct.kr/")
        print("   - 칼럼 정보마당: https://car-direct.kr/posts/")
        print("   - 사이트맵: https://car-direct.kr/sitemap.xml")
        print("   - 로봇 수집파일: https://car-direct.kr/robots.txt")
